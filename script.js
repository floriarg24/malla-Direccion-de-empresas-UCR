...
function render() {
  ...
  Object.keys(cursosPorSemestre).sort().forEach(semestre => {
    ...
    contMaterias.className = "contenedor-materias";

    cursosPorSemestre[semestre].forEach(curso => {
      const div = document.createElement("div");
      div.className = "materia" + (estado[curso.id] ? " aprobada" : "");
      div.id = curso.id;
    ...
    contenedor.appendChild(contMaterias);
